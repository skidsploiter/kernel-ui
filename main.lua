...
KRNL.Name = randomString(16) --"KRNL"
...
KrnlGUI.Name = randomString(16) --"KrnlGUI"
KrnlGUI.Parent = KRNL
KrnlGUI.Active = true
...
FileButton.Name = randomString(16) --"File Button"
...
CreditsButton.Name = randomString(16) --"Credits Button"
...
GamesButton.Name = randomString(16) --"Games Button"
...
HotScriptsButton.Name = randomString(16) --"Hot Scripts Button"
...
OthersButton.Name = randomString(16) --"Others Button"
...
SideGUI.Name = randomString(16) --"Side GUI"
...
Xbutton.Name = randomString(16) --"X button"
...
button.Name = randomString(16) --"- button"
...
MainGUI.Name = randomString(16) --"MainGUI"
...
ExecuteBar.Name = randomString(16) --"ExecuteBar"
...
Script1.Name = randomString(16) --"Script1"
...
Script2.Name = randomString(16) --"Script2"
...
addbutton.Name = randomString(16) --"addbutton"
...
ScrollingFrame1.Name = randomString(16) --"ScrollingFrame1"
...
security.Name = randomString(16) --"security"
...
EditorFrame.Name = randomString(16) --"EditorFrame"
...
Source.Name = randomString(16) --"Source"
...
Comments_.Name = randomString(16) --"Comments_"
...
Globals_.Name = randomString(16) --"Globals_"
...
Keywords_.Name = randomString(16) --"Keywords_"
...
RemoteHighlight_.Name = randomString(16) --"RemoteHighlight_"
...
Strings_.Name = randomString(16) --"Strings_"
...
Tokens_.Name = randomString(16) --"Tokens_"
...
Numbers_.Name = randomString(16) --"Numbers_"
...
Lines.Name = randomString(16) --"Lines"
...
ScrollingFrame2.Name = randomString(16) --"ScrollingFrame2"
...
security_2.Name = randomString(16) --"security"
...
EditorFrame_2.Name = randomString(16) --"EditorFrame"
...
Source_2.Name = randomString(16) --"Source"
...
Comments__2.Name = randomString(16) --"Comments_"
...
Globals__2.Name = randomString(16) --"Globals_"
...
Keywords__2.Name = randomString(16) --"Keywords_"
...
RemoteHighlight__2.Name = randomString(16) --"RemoteHighlight_"
...
Strings__2.Name = randomString(16) --"Strings_"
...
Tokens__2.Name = randomString(16) --"Tokens_"
...
Numbers__2.Name = randomString(16) --"Numbers_"
...
Lines_2.Name = randomString(16) --"Lines"
...
Execute.Name = randomString(16) --"Execute"
...
Clear.Name = randomString(16) --"Clear"
...
OpenFileButton.Name = randomString(16) --"Open File Button"
...
SaveFileButton.Name = randomString(16) --"Save File Button"
...
InjectButton.Name = randomString(16) --"Inject Button"
...
OptionButton.Name = randomString(16) --"Option Button"
...
ScriptHub.Name = randomString(16) --"Script Hub"
...
InjectedMessgae.Name = randomString(16) --"InjectedMessgae"
...
Xbutton_2.Name = randomString(16) --"X button"
...
Okbutton.Name = randomString(16) --"Ok button"
...
HScriptsHub.Name = randomString(16) --"HScriptsHub"
...
DexExplorer.Name = randomString(16) --"Dex Explorer"
...
OpenGui.Name = randomString(16) --"OpenGui"
...
RemoteSpy.Name = randomString(16) --"RemoteSpy"
...
DarkDex.Name = randomString(16) --"DarkDex"
...
UnamedEsp.Name = randomString(16) --"UnamedEsp"
...
IYFE.Name = randomString(16) --"IYFE"
...
OwlHub.Name = randomString(16) --"OwlHub"
...
HoHoHub.Name = randomString(16) --"HoHo Hub"
...
BlueLight.Name = randomString(16) --"Blue Light"
...
CreditsW.Name = randomString(16) --"CreditsW"
...
Xbutton_3.Name = randomString(16) --"X button"
...
TextLabel_5.Text = "kz | krnl remake v3"
...
OtherTab.Name = randomString(16) --"OtherTab"
...
Nope.Name = randomString(16) --"Nope"
...
FileTab.Name = randomString(16) --"FileTab"
...
KillTask.Name = randomString(16) --"KillTask"
...
Inject.Name = randomString(16) --"Inject"
...
GamesOpenGUI.Name = randomString(16) --"GamesOpenGUI"
...
Xbutton_4.Name = randomString(16) --"X button"
...
Okbutton_2.Name = randomString(16) --"Ok button"
...
FloatingGUI.Name = randomString(16) --"FloatingGUI"
